		...
		<div class="item-box">
			<div class="gallery-wrapper">
				<div class="gallery">
					<div class="thumbnail">
						<ul>
							<li :class="{'on':index==0}" key="index" v-for="img,index in itemsInfo.ali_images"><img :src="img" style="width:54px;height:54px"  ></li>
						</ul>
					</div>
					<div class="thumb">
						<ul>
							<li :class="{'on':index==0}" key="index" v-for="img,index in itemsInfo.ali_images"><vue-photo-zoom-pro :url="img" style="width:440px"></vue-photo-zoom-pro></li>
						</ul>
					</div>
				</div>
			</div>
					...
					<div class="sku-dynamic-params clear">
						...
						<ul class="params-colors">
							<li :class="{'cur':color.id==$route.query.itemId}" v-for="color,index in itemsInfo.sku_list">
								<router-link :to="{name: 'Item', query: {itemId:color.id}}" :title="color.color"><i><img :src="color.image"></i></router-link>
							</li>
						</ul>
					</div>
					<div class="sku-dynamic-params clear">
